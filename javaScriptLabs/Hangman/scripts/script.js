...
// elements as word has characters. Each index of revealedLetters will
 // correspond to a character in word, and if revealedLetters[n] is truthy,
 //  then word[n] has been correctly guessed.
